...
const CAT_CARDS: { key: string; label: string; icon: string; border: string; bg: string; bar: string }[] = [
  ...
  { key: "pqr",               label: "Solicitudes Postventa", icon: "📞", border: "border-cyan-200",   bg: "bg-cyan-50",   bar: "bg-cyan-500" },
  { key: "disciplinarios",    label: "Disciplinarios",     icon: "⚖️", border: "border-red-200",    bg: "bg-red-50",    bar: "bg-red-500" },
  { key: "eventos_criticos", label: "Eventos críticos",  icon: "🛡️", border: "border-orange-200", bg: "bg-orange-50", bar: "bg-orange-500" },
