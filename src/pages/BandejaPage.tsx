...
export default function BandejaPage() {
  ...
  }, [faltData, filtroEstadoFalt, filtroNovedadSG, filtroRegional, filtroTerminal, filtroCliente, dateRange]);
  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="max-w-7xl mx-auto p-6 space-y-4">
        ...
        {(hayFiltrosGeo || !!dateRange?.from || filtroCliente !== "todos") && (
              ...
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-border">
                  {faltVisible.length === 0 ? (
                    <tr><td colSpan={10} className="text-center py-8 text-muted-foreground">Sin guías faltantes en este filtro</td></tr>
